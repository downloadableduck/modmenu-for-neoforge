...
public class BadgeToogleButton extends LegacyTexturedButtonWidget {
   private static final Identifier BADGE_TOGGLE_TEXTURE = Identifier.parse("modmenu:textures/gui/badge_toggle_button.png");
   private boolean hasBadge;

   public BadgeToogleButton(int x, int y, int width, int height, int u, int v, int hoveredVOffset, OnPress pressAction, Component message, boolean hasBadge) {
   ...
   public static BadgeToogleButton.Builder badgeButtonBuilder(Component message, OnPress onPress, boolean hasBadge) {
